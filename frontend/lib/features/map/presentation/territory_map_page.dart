...
final class _TerritoryMapPageState extends ConsumerState<TerritoryMapPage> {
        ...
        children: [
          ...
          Expanded(
            child: ownerId == null || scope.parcelId == null
                ...
                : StreamBuilder<List<MapSectorView>>(
  ...
  Widget _map(List<MapSectorView> sectors, String? selectedId) {
  ...
  void _handleMapTap(LatLng point, List<MapSectorView> sectors) {
