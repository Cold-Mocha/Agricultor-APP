...
- Open-Meteo, Gemini y Firebase se invocan en Edge Functions. Open-Meteo usa el endpoint server-side; las claves privadas de Gemini y Firebase proceden exclusivamente de secretos del entorno.
