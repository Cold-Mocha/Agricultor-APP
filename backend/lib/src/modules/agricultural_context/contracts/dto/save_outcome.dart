/// Stable identifier for one user confirmation. It is also the idempotency key
/// used by repositories and the outbox; it deliberately has no infrastructure
/// dependency.
final class CommandId {
  ...
  bool operator ==(Object other) =>
      other is CommandId && other.value == value;
