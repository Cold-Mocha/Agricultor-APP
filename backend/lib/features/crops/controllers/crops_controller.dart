...
import 'package:agrocampo_backend/core/database/app_database.dart' as db;
import 'package:agrocampo_backend/features/crops/domain/agricultural_season.dart';
import 'package:agrocampo_backend/features/crops/domain/crop_ref.dart';
import 'package:agrocampo_backend/features/crops/domain/sector_crop_assignment.dart';
import 'package:agrocampo_backend/features/crops/repositories/agricultural_season_repository.dart';
import 'package:agrocampo_backend/features/crops/repositories/crop_exchange_repository.dart';
...
final cropsControllerProvider = Provider<CropsController>(
  (ref) => CropsController._(ref.watch(appDatabaseProvider)),
);
...
final class CropsController {
  CropsController._(this._database);
